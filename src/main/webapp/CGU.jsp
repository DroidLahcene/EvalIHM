...
<main>
    <div class="banniere ">
        ...
        <h1 class="text-dark text-center" >CONDITION<br> GENERALE<br> D'UTILISATION</h1>
        <div class="superpose">
    ...
    <div class="text-center col-10 mx-auto">
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet consequatur cum deleniti dolore inventore modi molestias nobis officia possimus provident quam quidem repellendus. </p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus aperiam aspernatur commodi consectetur deserunt distinctio, doloribus earum eos est ipsam laborum libero obcaecati perferendis quos reiciendis saepe sunt temporibus totam!</p>
    </div>
